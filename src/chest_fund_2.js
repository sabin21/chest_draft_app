import '../public/css/chest_fund.scss';
...
function articleInit(){
  const btnBottomList = document.getElementById('btn-bottom-list');
  const bottomList = document.querySelector('.list-bar-wrap');
  const pageOverlay = document.querySelector('.page-overlay');

  btnBottomList.addEventListener('click', ()=>{
